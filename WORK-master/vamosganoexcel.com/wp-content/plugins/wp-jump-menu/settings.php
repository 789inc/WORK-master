...
function wpjm_position_radio() {
	...
	<div>
		<input type="radio" value="wpAdminBar" name="wpjm_options[position]" id="wpjm_position"
		       class="wpjm_position" <?php checked( $wpjm_options['position'], 'wpAdminBar' ); ?> />
		WP Admin Bar<br/>
		<input type="radio" value='top' name="wpjm_options[position]" id="wpjm_position"
		       class="wpjm_position" <?php checked( $wpjm_options['position'], 'top' ); ?> />
		Top of screen*<br/>
		<input type="radio" value="bottom" name="wpjm_options[position]" id="wpjm_position"
		       class="wpjm_position" <?php checked( $wpjm_options['position'], 'bottom' ); ?> />
		Bottom of screen*<br/>
		<p><em>
...
function wpjm_frontend_checkbox() {
	...
	<div>
		<input type="checkbox" value="true" name="wpjm_options[frontend]" id="wpjm_frontend"
		       class="wpjm_frontend" <?php if ( isset( $wpjm_options['frontend'] ) ) {
			checked( $wpjm_options['frontend'], 'true' );
...
function wpjm_frontendjump_checkbox() {
	...
	<div>
		<input type="checkbox" value="true" name="wpjm_options[frontEndJump]" id="wpjm_frontEndJump"
		       class="wpjm_frontEndJump" <?php if ( isset( $wpjm_options['frontEndJump'] ) ) {
			checked( $wpjm_options['frontEndJump'], 'true' );
...
function wpjm_useChosen_checkbox() {
	...
	<div>
		<input type="checkbox" value="true" name="wpjm_options[useChosen]"
		       id="wpjm_useChosen" <?php if ( isset( $wpjm_options['useChosen'] ) ) {
			checked( $wpjm_options['useChosen'], 'true' );
...
// Use Shortcut Key
function wpjm_shortcutkey_checkbox() {
  global $wpjm_options;
  ?>
  <div>
    <input type="checkbox" value="true" name="wpjm_options[useShortcut]" id="wpjm_useShortcut"
           class="wpjm_useShortcut" <?php if ( isset( $wpjm_options['useShortcut'] ) ) {
      checked( $wpjm_options['useShortcut'], 'true' );
...
function wpjm_chosenTextAlign_radio() {
	...
	<div>
		<input type="radio" value="left" name="wpjm_options[chosenTextAlign]"
		       id="wpjm_chosenTextAlign" <?php checked( $wpjm_options['chosenTextAlign'], 'left' ); ?> /> Left Aligned
		<br/>
		<input type="radio" value="right" name="wpjm_options[chosenTextAlign]"
		       id="wpjm_chosenTextAlign" <?php checked( $wpjm_options['chosenTextAlign'], 'right' ); ?> /> Right Aligned
	</div>
	<?php
}
...
function wpjm_showID_checkbox() {
	...
	<div>
		<input type="checkbox" value="true" name="wpjm_options[showID]"
		       id="wpjm_showID" <?php if ( isset( $wpjm_options['showID'] ) ) {
			checked( $wpjm_options['showID'], 'true' );
		} ?> />&nbsp;&nbsp;<span
...
// Show Post Type
function wpjm_showPostType_checkbox() {
	global $wpjm_options;
	?>
	<div>
		<input type="checkbox" value="true" name="wpjm_options[showPostType]"
		       id="wpjm_showPostType" <?php if ( isset( $wpjm_options['showPostType'] ) ) {
			checked( $wpjm_options['showPostType'], 'true' );
...
function wpjm_showAddNew_checkbox() {
	...
	<div>
		<input type="checkbox" value="true" name="wpjm_options[showaddnew]"
		       id="wpjm_showaddnew" <?php if ( isset( $wpjm_options['showaddnew'] ) ) {
			checked( $wpjm_options['showaddnew'], 'true' );
		} ?> />&nbsp;&nbsp;<span
...
<div>
	<input class="colorPicker" type="text" name="wpjm_options[backgroundColor]" id="wpjm_backgroundColor"
	       value="<?php if ( isset( $wpjm_options['backgroundColor'] ) ) {
		       echo $wpjm_options['backgroundColor'];
...
<div>
	<input class="colorPicker" type="text" name="wpjm_options[borderColor]" id="wpjm_borderColor"
	       value="<?php if ( isset( $wpjm_options['borderColor'] ) ) {
		       echo $wpjm_options['borderColor'];
...
<div>
	<input class="colorPicker" type="text" name="wpjm_options[fontColor]" id="wpjm_fontColor"
	       value="<?php if ( isset( $wpjm_options['fontColor'] ) ) {
		       echo $wpjm_options['fontColor'];
...
<div>
	<input class="colorPicker" type="text" name="wpjm_options[linkColor]" id="wpjm_linkColor"
	       value="<?php if ( isset( $wpjm_options['linkColor'] ) ) {
		       echo $wpjm_options['linkColor'];
	...
	<div>
		...
		function wpjm_statusColors_checkbox() {
			...
			<div>
				<input class="colorPicker" type="text" name="wpjm_options[statusColors][publish]"
				       id="wpjm_statusColors_publish" value="<?php echo $wpjm_options['statusColors']['publish']; ?>"
				       size="6"/>
				<span class="description">Publish</span>
			</div>
			<div>
				<input class="colorPicker" type="text" name="wpjm_options[statusColors][pending]"
				       id="wpjm_statusColors_pending" value="<?php echo $wpjm_options['statusColors']['pending']; ?>"
				       size="6"/>
				<span class="description">Pending</span>
			</div>
			<div>
				<input class="colorPicker" type="text" name="wpjm_options[statusColors][draft]"
				       id="wpjm_statusColors_draft" value="<?php echo $wpjm_options['statusColors']['draft']; ?>"
				       size="6"/>
		...
		function wpjm_backgroundColor_text() {
			...
			<div>
				<input class="colorPicker" type="text" name="wpjm_options[backgroundColor]" id="wpjm_backgroundColor"
				       value="<?php echo $wpjm_options['backgroundColor']; ?>" rel="#jump_menu|backgroundColor"
				       size="6"/>
		...
		function wpjm_fontColor_text() {
			...
			<div>
				<input class="colorPicker" type="text" name="wpjm_options[fontColor]" id="wpjm_fontColor"
				       value="<?php echo $wpjm_options['fontColor']; ?>" rel="#jump_menu|color" size="6"/>
				<span class="description">Click to select color, or enter hex value</span>
			</div>
			<?php
		}
		...
		function wpjm_borderColor_text() {
			...
			<div>
				<input class="colorPicker" type="text" name="wpjm_options[borderColor]" id="wpjm_borderColor"
				       value="<?php echo $wpjm_options['borderColor']; ?>" rel="#jump_menu|borderColor" size="6"/>
				<span class="description">Click to select color, or enter hex value</span>
			</div>
			<?php
		}
		...
		<div>
			<input class="colorPicker" type="text" name="wpjm_options[linkColor]" id="wpjm_linkColor"
			       value="<?php echo $wpjm_options['linkColor']; ?>"
			       rel="#jump_menu p a:link, #jump_menu p a:visited, #jump_menu p a:hover|color" size="6"/>
			<span class="description">Click to select color, or enter hex value</span>
			<div>
				<?php
				...
				function wpjm_logoIcon_text() {
					...
					<div>
						<input type="text" name="wpjm_options[logoIcon]" id="wpjm_logoIcon"
						       value="<?php echo $wpjm_options['logoIcon']; ?>" size="75"/>
					</div>
				...
				function wpjm_message_textarea() {
					...
					<div>
						<textarea name="wpjm_options[message]" id="wpjm_message" cols="60"
						          rows="3"><?php echo $wpjm_options['message']; ?></textarea>
					</div>
				...
				function wpjm_title_text() {
					...
					<div>
						<input type="text" name="wpjm_options[title]" id="wpjm_title"
						       value="<?php echo $wpjm_options['title']; ?>" size="75"/>
					</div>
					<span
								...
								<tr class="<?php if ( $alt == "" ) {
									...
									<th class="check-column" scope="row">
										<input type="checkbox"
										       ...
										       value="1" <?php checked( $wpjm_options['postTypes'][ $pt->name ]['show'], 1 ); ?> />
									</td>
									<td>
									...
									<td>
										<div>
											<input type="text"
											       ...
											       value="<?php echo $wpjm_options['postTypes'][ $pt->name ]['numberposts']; ?>"
											       size="3"/>
									...
									<td>
										<select name="wpjm_options[postTypes][<?php echo $pt->name; ?>][sortby]"
											...
											<option
												value="menu_order" <?php selected( $wpjm_options['postTypes'][ $pt->name ]['sortby'], 'menu_order' ); ?>>
												Menu Order
											</option>
											<option
												value="author" <?php selected( $wpjm_options['postTypes'][ $pt->name ]['sortby'], 'author' ); ?>>
												Author
											</option>
											<option
												value="date" <?php selected( $wpjm_options['postTypes'][ $pt->name ]['sortby'], 'date' ); ?>>
												Date
											</option>
											<option
												value="ID" <?php selected( $wpjm_options['postTypes'][ $pt->name ]['sortby'], 'ID' ); ?>>
												ID
											</option>
											<option
												value="modified" <?php selected( $wpjm_options['postTypes'][ $pt->name ]['sortby'], 'modified' ); ?>>
												Modified
											</option>
											<option
												value="comment_count" <?php selected( $wpjm_options['postTypes'][ $pt->name ]['sortby'], 'comment_count' ); ?>>
												Comment Count
											</option>
											<option
												value="parent" <?php selected( $wpjm_options['postTypes'][ $pt->name ]['sortby'], 'parent' ); ?>>
												Parent
											</option>
											<option
												value="title" <?php selected( $wpjm_options['postTypes'][ $pt->name ]['sortby'], 'title' ); ?>>
												Title
											</option>
											<?php
											if ( $pt->name == 'attachment' ) { ?>
												<option
													value="mime_type" <?php selected( $wpjm_options['postTypes'][ $pt->name ]['sortby'], 'mime_type' ); ?>>
													Mime Type
												</option>
												<?php
											}
										...
										<?php if ( $pt->name == 'attachment' && isset( $wpjm_options['postTypes'][ $pt->name ]['postmimetypes'] ) ) { ?>
											<div class="mime-types">
												...
												<input type="checkbox" value="all"
												       ...
												       id="wpjm_postmimetypes<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['postmimetypes'] ) ) {
													echo( in_array( 'all', $wpjm_options['postTypes'][ $pt->name ]['postmimetypes'] ) ? ' checked="checked"' : '' );
												} ?> /> All
												<br/>
												<input type="checkbox" value="images"
												       name="wpjm_options[postTypes][<?php echo $pt->name; ?>][postmimetypes][]"
												       id="wpjm_postmimetypes<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['postmimetypes'] ) ) {
													echo( in_array( 'images', $wpjm_options['postTypes'][ $pt->name ]['postmimetypes'] ) ? ' checked="checked"' : '' );
												} ?> /> Images
												<br/>
												<input type="checkbox" value="videos"
												       name="wpjm_options[postTypes][<?php echo $pt->name; ?>][postmimetypes][]"
												       id="wpjm_postmimetypes<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['postmimetypes'] ) ) {
													echo( in_array( 'videos', $wpjm_options['postTypes'][ $pt->name ]['postmimetypes'] ) ? ' checked="checked"' : '' );
												} ?> /> Videos
												<br/>
												<input type="checkbox" value="audio"
												       name="wpjm_options[postTypes][<?php echo $pt->name; ?>][postmimetypes][]"
												       id="wpjm_postmimetypes<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['postmimetypes'] ) ) {
													echo( in_array( 'audio', $wpjm_options['postTypes'][ $pt->name ]['postmimetypes'] ) ? ' checked="checked"' : '' );
												} ?> /> Audio
												<br/>
												<input type="checkbox" value="documents"
												       name="wpjm_options[postTypes][<?php echo $pt->name; ?>][postmimetypes][]"
												       id="wpjm_postmimetypes<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['postmimetypes'] ) ) {
													echo( in_array( 'documents', $wpjm_options['postTypes'][ $pt->name ]['postmimetypes'] ) ? ' checked="checked"' : '' );
												} ?> /> Documents
												<br/>
									...
									<td>
										<div>
											<input type="radio" value="ASC"
											       ...
											       id="wpjm_sort<?php echo $pt->name; ?>" <?php checked( $wpjm_options['postTypes'][ $pt->name ]['sort'], 'ASC' ); ?> />
											ASC <span class="description">(a-z, 1-10)</span>
											<br>
											<input type="radio" value="DESC"
											       name="wpjm_options[postTypes][<?php echo $pt->name; ?>][sort]"
											       id="wpjm_sort<?php echo $pt->name; ?>" <?php checked( $wpjm_options['postTypes'][ $pt->name ]['sort'], 'DESC' ); ?> />
									...
									<td>
										<div style="float: left; margin-right: 20px;">
											<input type="checkbox" value="publish"
											       ...
											       id="wpjm_poststatus<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ) {
												echo( in_array( 'publish', $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ? ' checked="checked"' : '' );
											} ?> /> Publish<br/>

											<input type="checkbox" value="pending"
											       name="wpjm_options[postTypes][<?php echo $pt->name; ?>][poststatus][]"
											       id="wpjm_poststatus<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ) {
												echo( in_array( 'pending', $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ? ' checked="checked"' : '' );
											} ?> /> Pending<br/>

											<input type="checkbox" value="draft"
											       name="wpjm_options[postTypes][<?php echo $pt->name; ?>][poststatus][]"
											       id="wpjm_poststatus<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ) {
												echo( in_array( 'draft', $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ? ' checked="checked"' : '' );
											} ?> /> Draft<br/>

											<input type="checkbox" value="auto-draft"
											       name="wpjm_options[postTypes][<?php echo $pt->name; ?>][poststatus][]"
											       id="wpjm_poststatus<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ) {
												echo( in_array( 'auto-draft', $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ? ' checked="checked"' : '' );
											} ?> /> Auto-Draft<br/>

											<input type="checkbox" value="future"
											       name="wpjm_options[postTypes][<?php echo $pt->name; ?>][poststatus][]"
											       id="wpjm_poststatus<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ) {
												echo( in_array( 'future', $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ? ' checked="checked"' : '' );
											} ?> /> Future<br/>
										...
										<div style="float: left;">
											<input type="checkbox" value="private"
											       name="wpjm_options[postTypes][<?php echo $pt->name; ?>][poststatus][]"
											       id="wpjm_poststatus<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ) {
												echo( in_array( 'private', $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ? ' checked="checked"' : '' );
											} ?> /> Private<br/>

											<input type="checkbox" value="inherit"
											       name="wpjm_options[postTypes][<?php echo $pt->name; ?>][poststatus][]"
											       id="wpjm_poststatus<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ) {
												echo( in_array( 'inherit', $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ? ' checked="checked"' : '' );
											} ?> /> Inherit<br/>

											<input type="checkbox" value="trash"
											       name="wpjm_options[postTypes][<?php echo $pt->name; ?>][poststatus][]"
											       id="wpjm_poststatus<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ) {
												echo( in_array( 'trash', $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ? ' checked="checked"' : '' );
											} ?> /> Trash<br/>

											<input type="checkbox" value="any"
											       name="wpjm_options[postTypes][<?php echo $pt->name; ?>][poststatus][]"
											       id="wpjm_poststatus<?php echo $pt->name; ?>" <?php if ( is_array( $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ) {
												echo( in_array( 'any', $wpjm_options['postTypes'][ $pt->name ]['poststatus'] ) ? ' checked="checked"' : '' );
											} ?> /> Any<br/>
										</div>
...
//	update_option( 'wpjm_needs_refresh', 1 );
					$needs_refresh = set_transient( 'wpjm_needs_refresh', 1 );
